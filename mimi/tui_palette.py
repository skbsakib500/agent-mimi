...
COMMANDS = [
    ...
    ("nusrat",   "Talk to Nusrat (chair)",   "mimi.council.tui_chat"),
    ...
    ("lab",      "Upgrade Lab (safe)",        "mimi.upgrade.lab"),
    ("detect",   "Run self-diagnosis",        "mimi.upgrade.detect"),
    ("sonar",    "Full health diagnostic",    "mimi.health.diagnostic"),
