...
CATEGORIES = {
    ...
    "6": {"title": "INTELLIGENCE", "icon": "[i]", "items": [
        ...
        ("Weekly Review", "mimi.ai_review"),
        ("Daily Plan", "mimi.ai_plan"),
        ("Predict", "mimi.predict"),
        ("Suggest", "mimi.suggest"),
        ("Notifications", "mimi.notify_setup"),
        ("Voice", "mimi.speak"),
        ("Voice Command", "mimi.voice"),
        ("Vision", "mimi.vision"),
        ("AI Chat", "mimi.ai_chat_tui"),
        ("Telegram Bot", "mimi.telegram_bot"),
        ("Location", "mimi.location_tui"),
        ("Auto-Learn", "mimi.learn_tui"),
        ("Modes", "mimi.persona_tui"),
        ("Self-Upgrade", "mimi.self_update"),
        ("Backup", "mimi.backup"),
